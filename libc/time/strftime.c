    ...
    for( const char* f = fmt; *f; f++ )
    {
        ...
        switch( *f )
        {
            ...
            case 'B':
                ...
                break;
            case 'c':
                b += sprintf(b, "%s %s %02d %02d:%02d:%02d %04d", weekdays_short[tm->tm_wday],
            ...
            case 'P':
                ...
                break;
            case 'r':
                b += sprintf(b, "%02d:%02d:%02d %s", tm->tm_hour == 0 ? 12 : (tm->tm_hour == 12 ? 12 : (tm->tm_hour % 12)),
                                                     tm->tm_min,
                                                     tm->tm_sec,
                                                     tm->tm_hour < 12 ? "AM" : "PM");
                break;
            ...
            case 't':
                ...
                break;
            case 'T':
                b += sprintf(b, "%02d:%02d:%02d", tm->tm_hour,
                                                  tm->tm_min,
                                                  tm->tm_sec);
                break;
            case 'u':

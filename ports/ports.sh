...
pushd binutils-port
    $TOOLCHAIN/../tarballs/binutils-2.32/configure --host=$HOST --with-sysroot=/ --prefix='' --exec-prefix='' --bindir=/bin --libexecdir=/lib --libdir=/lib --datarootdir=/lib --disable-nls --disable-werror || exit 1
